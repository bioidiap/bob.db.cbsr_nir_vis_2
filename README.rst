...
.. image:: http://img.shields.io/badge/docs-v2.0.6-yellow.png
   :target: https://www.idiap.ch/software/bob/docs/bob/bob.db.cbsr_nir_vis_2/v2.0.6/index.html
.. image:: http://img.shields.io/badge/docs-latest-orange.png
   :target: https://www.idiap.ch/software/bob/docs/bob/bob.db.cbsr_nir_vis_2/master/index.html
.. image:: https://gitlab.idiap.ch/bob/bob.db.cbsr_nir_vis_2/badges/v2.0.6/build.svg
   :target: https://gitlab.idiap.ch/bob/bob.db.cbsr_nir_vis_2/commits/v2.0.6
